    ...
    return (
        <div className='flex items-center flex-col border-2 rounded-2xl p-6 relative'>
            ...
            <span className='flex flex-col items-center relative top-4'>
                <p className='font-bold text-primary text-2xl'>{session?.user?.name}</p>
                <h6 className='font-bold text-primary text-base opacity-80'>Operator</h6>
            </span>
            <div className='flex flex-col lg:flex-row gap-4 w-full items-center justify-between top-12 relative'>
                <div className='flex flex-col w-16 items-center'>
                    <span className='flex items-center justify-center gap-2 pb-2'>
                        <p className='text-primary truncate text-sm font-semibold'>5</p>
                        <Medal size={20} />
                    </span>
                    <p className='text-primary truncate text-xs font-medium'>Years with us</p>
                </div>
                <div className='flex flex-col w-16 items-center'>
                    <span className='flex items-center justify-center gap-2 pb-2'>
                        <p className='text-primary truncate text-sm font-semibold'>560</p>
                        <PackageSearch size={20} />
                    </span>
                    <p className='text-primary truncate text-xs font-medium'>Total Reviews</p>
                </div>
                <div className='flex flex-col w-16 items-center'>
                    <span className='flex items-center justify-center gap-2 pb-2'>
                        <p className='text-primary truncate text-sm font-semibold'>4.6 / 10</p>
                        <Star size={20} />
                    </span>
                    <p className='text-primary truncate text-xs font-medium'>Reviews</p>
                </div>
            </div>
